...
x = dan(2023,10,20)
if x:pass
else:quit('\033[1;32mتم ايقاف الاداه راسل جوبا لتفعيل \n❖ - https://t.me/J_O_P_A_4')  
print("\033[1;32m❖ - تم التفعيل ")
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s <JOPA> %s/%s » [OK] %s » [CP] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
