...
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+' انتهئ التفعيل انضم للقناه للحصول ع احدث نسخه\n❖ - https://t.me/J_O_P_A_4' )
 print('\n\n')
 print(x)
...
def menu(my_name,my_id):
	...
	print(Z+'\033[1;32m❖ - https://t.me/J_O_P_A_4 ')
	print(F+          'مدفوعه')
	print('[v-1]')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s <JOBA> %s/%s » [OK] %s » [CP] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
